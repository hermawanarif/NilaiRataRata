...
public class InputPerhitungan {
    ...
    public static void tugaspt3nomor2() {
        ...
        num1 = JOptionPane.showInputDialog(null,"Masukkan Nilai num 1 = ","Inputkan Angka",JOptionPane.INFORMATION_MESSAGE);
        int no1 = Integer.parseInt(num1);
        num2 = JOptionPane.showInputDialog(null,"Masukkan Nilai num 2 = ","Inputkan Angka",JOptionPane.INFORMATION_MESSAGE);
        int no2 = Integer.parseInt(num2);
        num3 = JOptionPane.showInputDialog(null,"Masukkan Nilai num 3 = ","Inputkan Angka",JOptionPane.INFORMATION_MESSAGE);
